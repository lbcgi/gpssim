...
#define MAX_SAT (32)  // 32

/*! \brief Maximum number of channels we simulate */
#define MAX_CHAN (1) // 16

/*! \brief Maximum number of user motion points */
#ifndef USER_MOTION_SIZE
#define USER_MOTION_SIZE (3000) // max duration at 10Hz, is equal 10*duration(second) 
#endif
...
//#define CARR_FREQ (3.996e6)

#define LAMBDA_L1 (SPEED_OF_LIGHT/CARR_FREQ)


/*! \brief C/A code frequency */
#define CODE_FREQ (1.023e6)
//#define CARR_TO_CODE (1.0/1540.0) // 此处为何是固定的？
#define CARR_TO_CODE (CODE_FREQ/CARR_FREQ) // 此处为何是固定的？
